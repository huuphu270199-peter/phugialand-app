const CACHE_NAME = 'phu-gia-land-v67';
...
const APP_SHELL = isTenantPortal ? [
  ...
  './tenant.html?v=67',
  './tenant.css?v=67',
  './vietnamese-typography.css?v=67',
  './tenant.js?v=67',
  './tenant.webmanifest?v=67',
  ...
  './styles.css?v=67',
  './modal.css?v=67',
  './enhancements.css?v=67',
  './redesign.css?v=67',
  './crud.css?v=67',
  './utility-manager.css?v=67',
  './vietnamese-typography.css?v=67',
  './building-form.css?v=67',
  './building-manager.css?v=67',
  './homestay.css?v=67',
  './customer-manager.css?v=67',
  './customer-detail.css?v=67',
  './vp-theme.css?v=67',
  './app.js?v=67',
