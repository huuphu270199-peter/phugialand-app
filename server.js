...
const appFiles = new Set(['index.html', 'styles.css', 'modal.css', 'enhancements.css', 'redesign.css', 'crud.css', 'building-form.css', 'building-manager.css', 'customer-manager.css', 'customer-detail.css', 'vp-theme.css', 'app.js', 'sw.js', 'manifest.webmanifest', 'assets/icon.svg', 'assets/Logo BPG.jpg']);
